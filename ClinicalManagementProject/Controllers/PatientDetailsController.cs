...
namespace ClinicalManagementProject.Controllers
{
    public class PatientDetailsController : Controller
    {
        ...
        public PatientDetailsController(ClinicalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PatientId,PatientFirstName,PatientLastName,Sex,Age,DateOfBirth")] PatientDetails patientDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatientId,PatientFirstName,PatientLastName,Sex,Age,DateOfBirth")] PatientDetails patientDetails)
        {
